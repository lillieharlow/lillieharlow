...
Junior Full-Stack Developer | Junior Software Engineer
<br>
...
Languages: ![Languages](https://skillicons.dev/icons?i=js,python,html,css)
<br>
Frameworks/libraries: ![Frameworks](https://skillicons.dev/icons?i=react,nodejs,express,django,flask)
<br>
Tools: ![Tools](https://skillicons.dev/icons?i=git,github,githubactions,vscode,insomnia,aws,gcp,render)
<br>
Databases: ![Databases](https://skillicons.dev/icons?i=mongodb,postgres,sqlite)
<br>
Design/Collab: [![Design/Collab](https://skillicons.dev/icons?i=figma,ps,trello)](https://skillicons.dev)
